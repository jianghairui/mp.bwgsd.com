<?php /*a:3:{s:64:"/mnt/www.caves.vip/application/admin/view/shop/goods_detail.html";i:1555419774;s:53:"/mnt/www.caves.vip/application/admin/view/layout.html";i:1539060499;s:60:"/mnt/www.caves.vip/application/admin/view/public/footer.html";i:1537872047;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<article class="page-container">
    <form class="form form-horizontal" id="form-article-add">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <div class="uploader-thum-container">
                    <div id="fileList" class="uploader-list">
                        <?php $images = unserialize($info['pics']);foreach($images as $v): ?>
                        <div id="cover" class="thumbnail" style="background-image: url('/<?php echo htmlentities($v); ?>');"><div class="file-panel">
                            <input type="hidden" value="<?php echo htmlentities($v); ?>" name="pic_url[]"/></div></div>
                        <?php endforeach; ?>
                    </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="<?php echo htmlentities($info['origin_price']); ?>" placeholder="金额格式 0.00" id="origin_price" name="origin_price" oninput="this.value=/^\d{1,8}(\.\d{0,2})?$/.test(this.value) ? this.value : this.value.substring(0,this.value.length-1)">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">商品价格：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="<?php echo htmlentities($info['price']); ?>" placeholder="金额格式 0.00" id="price" name="price" oninput="this.value=/^\d{1,8}(\.\d{0,2})?$/.test(this.value) ? this.value : this.value.substring(0,this.value.length-1)">
            </div>
        </div>
        <div class="row cl">
        ...
        <div class="row cl" id="attr_detail">
            ...
            <div class="row cl">
                ...
                <div class="formControls col-sm-2">
                    ...
                    <input type="text" class="input-text" value="<?php echo htmlentities($li['value']); ?>" name="attr1[]">
                </div>
                <div class="formControls col-sm-2">
                    <input type="text" class="input-text" value="<?php echo htmlentities($li['price']); ?>" name="attr2[]">
                </div>
                <div class="formControls col-sm-2">
                    <input type="number" class="input-text" value="<?php echo htmlentities($li['stock']); ?>" name="attr3[]">
                </div>
            </div>
            <?php endforeach; ?>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="<?php echo htmlentities($info['carriage']); ?>" placeholder="金额格式 0.00" id="carriage" name="carriage" oninput="this.value=/^\d{1,8}(\.\d{0,2})?$/.test(this.value) ? this.value : this.value.substring(0,this.value.length-1)">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">满*元免运费：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="<?php echo htmlentities($info['reduction']); ?>" placeholder="金额格式 0.00" id="reduction" name="reduction" oninput="this.value=/^\d{1,8}(\.\d{0,2})?$/.test(this.value) ? this.value : this.value.substring(0,this.value.length-1)">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">商家服务：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="<?php echo htmlentities($info['service']); ?>" placeholder="7天无理由退换" id="service" name="service" maxlength="8">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">单位：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="<?php echo htmlentities($info['unit']); ?>" placeholder="单位:件" id="unit" name="unit" maxlength="8">
            </div>
        </div>
        <div class="row cl">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <textarea name="desc" id="desc" cols="" rows="" maxlength="50" class="textarea"  placeholder="说点什么...最少输入10个字符" dragonfly="true" nullmsg="备注不能为空！" ><?php echo htmlentities($info['desc']); ?></textarea>
            </div>
        </div>
