<?php /*a:3:{s:71:"/var/www/caves.wcip.net/application/admin/view/banner/video_detail.html";i:1570842583;s:58:"/var/www/caves.wcip.net/application/admin/view/layout.html";i:1566381559;s:65:"/var/www/caves.wcip.net/application/admin/view/public/footer.html";i:1566381559;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
    ...
    <form class="form form-horizontal" id="formAjax">
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="<?php echo htmlentities($info['title']); ?>" placeholder="" name="title" maxlength="30">
            </div>
        </div>
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <div class="uploader-thum-container">
                    <div id="fileList" class="uploader-list">
                        <img class="thumbnail" src="<?php echo htmlentities($qiniu_weburl); ?><?php echo htmlentities($info['poster']); ?>" />
                    </div>
                </div>
            </div>
        </div>
        ...
        <input type="hidden" name="poster" id="poster" value="<?php echo htmlentities($info['poster']); ?>">
        ...
        $("#formAjax").validate({
            ...
            submitHandler:function(form){
                if(isclick === true) {
                    ...
                    $(form).ajaxSubmit({
                        type: 'post',
                        url: "<?php echo url('Banner/videoMod'); ?>" ,
