<?php /*a:3:{s:70:"/var/www/caves.wcip.net/application/admin/view/funding/goods_list.html";i:1567663121;s:58:"/var/www/caves.wcip.net/application/admin/view/layout.html";i:1566381559;s:65:"/var/www/caves.wcip.net/application/admin/view/public/footer.html";i:1566381559;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<div class="page-container">
    ...
    <div class="cl pd-5 bg-1 bk-gray mt-20">
        <span class="l">
            <a class="btn btn-primary radius" data-title="添加商品" data-href="article-add.html" onclick="pagefull('添加商品','<?php echo url("Funding/goodsAdd"); ?>')" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 添加商品
            </a>
        </span>
        ...
        <form id="multi-check">
            ...
            <tr class="text-c userinfo">
                ...
                <td class="td-manage">
                    ...
                    <?php endif; ?>
                    <a style="text-decoration:none" onclick="pagefull('商品信息','<?php echo url("Funding/goodsDetail",array("id"=>$li["id"])); ?>')" class="ml-5" href="javascript:;" title="查看商品">
                    <i class="Hui-iconfont">&#xe6df;</i>
                    </a>
                </td>
            </tr>
...
<script type="text/javascript">
    ...
    var url = '<?php echo url("Funding/goodsList"); ?>' + '?<?php echo $page["query"];?>';
    ...
    $("#search-btn").click(function () {
        ...
        window.location.href = '<?php echo url("Funding/goodsList"); ?>' + '?' + str;
    });
    ...
    function goods_hide(obj,id){
        layer.confirm('确认要下架吗？',function(index){
            $.ajax({
                url:"<?php echo url('Funding/goodsHide'); ?>",
                type:'post',
                dataType:'json',
                data:{id:id},
    ...
    function goods_show(obj,id){
        layer.confirm('确认要上架吗？',function(index){
            $.ajax({
                url:"<?php echo url('Funding/goodsShow'); ?>",
                type:'post',
                dataType:'json',
                data:{id:id},
                success:function(data) {
