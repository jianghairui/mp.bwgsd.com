<?php /*a:3:{s:70:"/var/www/caves.wcip.net/application/admin/view/funding/order_send.html";i:1568614929;s:58:"/var/www/caves.wcip.net/application/admin/view/layout.html";i:1566381559;s:65:"/var/www/caves.wcip.net/application/admin/view/public/footer.html";i:1566381559;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
        ...
        $("#form-admin-add").validate({
            ...
            submitHandler:function(form){
                if(isclick) {
                    ...
                    $(form).ajaxSubmit({
                        type: 'post',
                        url: "<?php echo url('Funding/deliver'); ?>" ,
