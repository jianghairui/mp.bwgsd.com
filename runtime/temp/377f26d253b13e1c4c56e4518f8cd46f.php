<?php /*a:3:{s:70:"/var/www/caves.wcip.net/application/admin/view/req/show_work_list.html";i:1571797236;s:58:"/var/www/caves.wcip.net/application/admin/view/layout.html";i:1566381559;s:65:"/var/www/caves.wcip.net/application/admin/view/public/footer.html";i:1566381559;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 展示作品 <span class="c-gray en">&gt;</span> 作品列表 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
    ...
    <table class="table table-border table-bordered table-bg">
        ...
        <form id="multi-check">
            ...
            <tr class="text-c userinfo">
                ...
                <td class="td-manage">
                    <span>
                        <a style="text-decoration:none" onclick="pagefull('作品详情','<?php echo url("Req/showWorkDetail",array("id"=>$li["id"])); ?>')" href="javascript:;" title="作品详情">
...
<script type="text/javascript">
    ...
    var url = '<?php echo url("Req/showWorkList"); ?>' + '?<?php echo $page["query"];?>';
    ...
    $("#search-btn").click(function () {
        ...
        window.location.href = '<?php echo url("Req/showWorkList"); ?>' + '?' + str;
    });
    ...
    function work_del(obj,id){
        layer.confirm('确认要删除吗？',function(index){
            $.ajax({
                url: "<?php echo url('Req/showWorkDel'); ?>",
                type: 'POST',
                dataType: 'json',
                data:{id:id},
    ...
    function work_shenhe(obj,id){
        layer.confirm('审核作品？', {
            ...
            function(){
                $.ajax({
                    url:"<?php echo url('Req/showWorkPass'); ?>",
                    type:'post',
                    dataType:'json',
                    data:{id:id},
                    success:function(data) {
            ...
            function(){
                layer.prompt({
                    ...
                    layer.close(index);
                    $.ajax({
                        url:"<?php echo url('Req/showWorkReject'); ?>",
                        type:'post',
                        dataType:'json',
