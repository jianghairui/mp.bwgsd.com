<?php /*a:3:{s:68:"/var/www/caves.wcip.net/application/user/view/shop/goods_detail.html";i:1571110181;s:57:"/var/www/caves.wcip.net/application/user/view/layout.html";i:1566381559;s:64:"/var/www/caves.wcip.net/application/user/view/public/footer.html";i:1566381559;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
    ...
    <form class="form form-horizontal" id="form-article-add">
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-4">
                <?php if($info['check'] == 0): ?>
                <span class="goods-check" style="color: #00CC99">审核中</span>
                <?php endif; if($info['check'] == 2): ?>
                <span class="goods-check" style="color: red">审核未通过 : <?php echo htmlentities($info['reason']); ?></span>
                <?php endif; ?>
            </div>
        </div>
        <div class="row cl">
        ...
        <div class="row cl">
            <div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
                <button class="btn btn-primary radius" type="submit" onclick="return confirm('编辑商品将使商品下架,且需要重新审核,确定编辑吗')"><i class="Hui-iconfont">&#xe632;</i> 编辑</button>
