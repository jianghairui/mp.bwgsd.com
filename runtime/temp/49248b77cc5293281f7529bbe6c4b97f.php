<?php /*a:3:{s:69:"/var/www/caves.wcip.net/application/admin/view/funding/goods_add.html";i:1569806140;s:58:"/var/www/caves.wcip.net/application/admin/view/layout.html";i:1566381559;s:65:"/var/www/caves.wcip.net/application/admin/view/public/footer.html";i:1566381559;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
    ...
    <form class="form form-horizontal" id="form-article-add">
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9"> <span class="select-box">
				<select class="select" name="funding_id" id="funding_id">
                    <?php foreach($list as $li): ?>
					<option value="<?php echo htmlentities($li['id']); ?>">ID: <?php echo htmlentities($li['id']); ?> <?php echo htmlentities($li['title']); ?></option>
                    <?php endforeach; ?>
				</select>
				</span>
            </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-4 col-sm-4">
                <input type="text" id="send_date" name="send_date" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd',minDate:'#F{ \'%y-%M-%d\'}' })" value="" class="input-text Wdate">
            </div>
        </div>
        <div class="row cl">
        ...
        $("#form-article-add").validate({
            ...
            submitHandler:function(form){
                ...
                if(isclick === true) {
                    ...
                    $(form).ajaxSubmit({
                        type: 'post',
                        url: "<?php echo url('Funding/goodsAdd'); ?>" ,
