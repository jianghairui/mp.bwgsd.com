<?php /*a:3:{s:67:"/var/www/caves.wcip.net/application/admin/view/req/idea_detail.html";i:1570761442;s:58:"/var/www/caves.wcip.net/application/admin/view/layout.html";i:1566381559;s:65:"/var/www/caves.wcip.net/application/admin/view/public/footer.html";i:1566381559;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<article class="page-container">
    <form class="form form-horizontal" id="form-article-add">
        ...
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3">创意票数：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <span class=""><?php echo htmlentities($info['vote']); ?></span>
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3">作品数：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <span class=""><?php echo htmlentities($info['works_num']); ?></span>
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>创意标题：</label>
            <div class="formControls col-xs-8 col-sm-9">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <textarea name="content" cols="" rows="" class="textarea" maxlength="500" placeholder="" oninput="this.value.length<=500?$('#textlen1').text(this.value.length):$('#textlen1').text(500)" ><?php echo htmlentities($info['content']); ?></textarea>
                <p class="textarea-numberbar"><em class="textarea-length" id="textlen1">0</em>/500</p>
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3">创意来源：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <span class=""><?php echo htmlentities($info['req_title']); ?> (<?php echo htmlentities($info['org']); ?>) </span>
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3">创意时间：</label>
            <div class="formControls col-xs-8 col-sm-9">
