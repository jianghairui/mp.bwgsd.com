<?php /*a:3:{s:66:"/var/www/caves.wcip.net/application/admin/view/fake/role_list.html";i:1571368924;s:58:"/var/www/caves.wcip.net/application/admin/view/layout.html";i:1566381559;s:65:"/var/www/caves.wcip.net/application/admin/view/public/footer.html";i:1566381559;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<div class="page-container">
    ...
    <div class="cl pd-5 bg-1 bk-gray mt-20">
        <span class="l">
            <a class="btn btn-primary radius" data-title="添加角色" data-href="" onclick="pagefull('添加角色','<?php echo url("Fake/roleAdd"); ?>')" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 添加角色
            </a>
        </span>
    ...
    <table class="table table-border table-bordered table-bg">
        ...
        <tbody>
            ...
            <tr class="text-c userinfo">
                ...
                <td class="td-manage">
                    <a title="查看详情" href="javascript:;" onclick="pagefull('用户信息','<?php echo url("Fake/roleDetail",array("id"=>$li['id'])); ?>')" class="ml-5" style="text-decoration:none">
...
<script type="text/javascript">
    ...
    var url = '<?php echo url("Fake/roleList"); ?>' + '?<?php echo $page["query"];?>';
    ...
    $("#search-btn").click(function () {
        ...
        window.location.href = '<?php echo url("Fake/roleList"); ?>' + '?' + str;
    });
