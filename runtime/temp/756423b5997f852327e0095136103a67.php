<?php /*a:3:{s:72:"/var/www/caves.wcip.net/application/admin/view/funding/goods_detail.html";i:1569806140;s:58:"/var/www/caves.wcip.net/application/admin/view/layout.html";i:1566381559;s:65:"/var/www/caves.wcip.net/application/admin/view/public/footer.html";i:1566381559;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<article class="page-container">
    <form class="form form-horizontal" id="form-article-add">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="<?php echo htmlentities($info['name']); ?>" placeholder="" id="name" name="name" maxlength="20">
            </div>
        </div>
        <div class="row cl">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" id="price" name="price" class="input-text" value="<?php echo htmlentities($info['price']); ?>" placeholder="金额格式 0.00" onkeyup="onlyNumber(this)">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>预计发送时间：</label>
            <div class="formControls col-xs-4 col-sm-4">
                <input type="text" id="send_date" name="send_date" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd',minDate:'#F{ \'%y-%M-%d\'}' })" value="<?php echo htmlentities($info['send_date']); ?>" class="input-text Wdate">
            </div>
        </div>
        <div class="row cl">
        ...
        $("#form-article-add").validate({
            ...
            submitHandler:function(form){
                ...
                if(isclick === true) {
                    ...
                    $(form).ajaxSubmit({
                        type: 'post',
                        url: "<?php echo url('Funding/goodsMod'); ?>" ,
