<?php /*a:3:{s:70:"/var/www/caves.wcip.net/application/admin/view/user/recharge_list.html";i:1570786147;s:58:"/var/www/caves.wcip.net/application/admin/view/layout.html";i:1566381559;s:65:"/var/www/caves.wcip.net/application/admin/view/public/footer.html";i:1566381559;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 会员管理 <span class="c-gray en">&gt;</span> 充值记录 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
    ...
    <table class="table table-border table-bordered table-bg">
        ...
        <form id="multi-check">
            ...
            <tr class="text-c userinfo">
                ...
                <td class="td-manage">
                    <a title="查看详情" href="javascript:;" onclick="detail('订单详情','<?php echo url("User/rechargeDetail",array("id"=>$li["id"])); ?>')">
                    <i class="Hui-iconfont">&#xe6df;</i>
                    </a>
                    <?php if($li['send'] == 0 && $li['status'] == 1): ?>
                    <a title="发货" href="javascript:;" onclick="order_send('订单发货','<?php echo url("User/orderSend",array("id"=>$li["id"])); ?>','600','400')"">
                        <i class="Hui-iconfont">&#xe669;</i>
                    </a>
                    <?php endif; ?>
                </td>
...
<script type="text/javascript">
    ...
    var url = '<?php echo url("User/rechargeList"); ?>' + '?<?php echo $page["query"];?>';
    ...
    $("#search-btn").click(function () {
        ...
        window.location.href = '<?php echo url("User/rechargeList"); ?>' + '?' + str;
    });
