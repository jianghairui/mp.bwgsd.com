<?php /*a:3:{s:65:"/var/www/caves.wcip.net/application/admin/view/fake/role_add.html";i:1576568420;s:58:"/var/www/caves.wcip.net/application/admin/view/layout.html";i:1566381559;s:65:"/var/www/caves.wcip.net/application/admin/view/public/footer.html";i:1566381559;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<article class="page-container">
    <form class="form form-horizontal" id="form-article-add">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="" placeholder="手机号" id="tel" name="tel" maxlength="15">
            </div>
        </div>
        <div class="row cl">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-2 col-sm-2" > <span class="select-box">
				<select class="select" name="provinceCode" id="provinceCode">
					...
					<option value="<?php echo htmlentities($li['code']); ?>"><?php echo htmlentities($li['name']); ?></option>
                    <?php endforeach; ?>
				</select>
				</span>
            </div>
