<?php /*a:3:{s:63:"/var/www/caves.wcip.net/application/admin/view/req/req_add.html";i:1570842584;s:58:"/var/www/caves.wcip.net/application/admin/view/layout.html";i:1566381559;s:65:"/var/www/caves.wcip.net/application/admin/view/public/footer.html";i:1566381559;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
    ...
    <form class="form form-horizontal" id="form-article-add">
        <div class="row cl">
            ...
            <div class="formControls col-xs-4 col-sm-4">
                ...
                <select class="select" name="uid" id="uid">
                    <?php foreach($list as $v): ?>
                    <option value="<?php echo htmlentities($v['id']); ?>" ><?php echo htmlentities($v['org']); ?> (id: <?php echo htmlentities($v['id']); ?>)</option>
                    <?php endforeach; ?>
				</select>
                </span>
            </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="XXXX文创大赛" placeholder="输入活动标题" id="title" name="title" maxlength="30">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>征集主题：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="不限制" placeholder="活动征集主题" id="theme" name="theme" maxlength="50">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>联系人：</label>
            <div class="formControls col-xs-4 col-sm-4">
                <input type="text" class="input-text" value="博小虎" placeholder="联系人姓名" id="linkman" name="linkman" maxlength="15">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>联系电话：</label>
            <div class="formControls col-xs-4 col-sm-4">
                <input type="text" class="input-text" value="18622388853" placeholder="联系电话" id="tel" name="tel" maxlength="15">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>邮箱：</label>
            <div class="formControls col-xs-4 col-sm-4">
                <input type="email" class="input-text" value="jhr@bwg.art" placeholder="联系邮箱" id="email" name="email" maxlength="50">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>微信：</label>
            <div class="formControls col-xs-4 col-sm-4">
                <input type="text" class="input-text" value="Jianghairui1992" placeholder="微信号(选填)" id="weixin" name="weixin" maxlength="50">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>活动开始时间：</label>
            <div class="formControls col-xs-4 col-sm-4">
                <input type="text" id="start_time" name="start_time" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd',maxDate:'#F{ $dp.$D(\'deadline\')}' })" value="" class="input-text Wdate" readonly>
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>截止创意投稿时间：</label>
            <div class="formControls col-xs-4 col-sm-4">
                <input type="text" id="deadline" name="deadline" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd',maxDate:'#F{ $dp.$D(\'vote_time\')}',minDate:'#F{ $dp.$D(\'start_time\')}' })" value="" class="input-text Wdate" readonly>
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>截止投票时间：</label>
            <div class="formControls col-xs-4 col-sm-4">
                <input type="text" id="vote_time" name="vote_time" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd',maxDate:'#F{ $dp.$D(\'end_time\')}',minDate:'#F{ $dp.$D(\'deadline\')}' })" value="" class="input-text Wdate" readonly>
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>活动结束时间：</label>
            <div class="formControls col-xs-4 col-sm-4">
                <input type="text" id="end_time" name="end_time" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd',minDate:'#F{ $dp.$D(\'vote_time\')}' })" value="" class="input-text Wdate" readonly>
            </div>
        </div>
        <div class="row cl">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <textarea id="editor" type="text/plain" name="explain" style="width:100%;height:400px;"></textarea>
            </div>
        </div>
