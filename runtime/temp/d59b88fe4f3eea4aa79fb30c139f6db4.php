<?php /*a:3:{s:63:"/mnt/www.caves.vip/application/admin/view/shop/cate_detail.html";i:1553500527;s:53:"/mnt/www.caves.vip/application/admin/view/layout.html";i:1539060499;s:60:"/mnt/www.caves.vip/application/admin/view/public/footer.html";i:1537872047;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <div class="uploader-thum-container">
                    <div id="fileList" class="uploader-list">
                        <div id="cover" class="thumbnail" style="background-image: url('/<?php echo htmlentities($info['icon']); ?>');"><div class="file-panel"></div></div>
                    </div>
                </div>
            </div>
        </div>
