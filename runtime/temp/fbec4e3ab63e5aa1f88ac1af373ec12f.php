<?php /*a:3:{s:65:"/var/www/caves.wcip.net/application/admin/view/req/idea_list.html";i:1568129614;s:58:"/var/www/caves.wcip.net/application/admin/view/layout.html";i:1566381559;s:65:"/var/www/caves.wcip.net/application/admin/view/public/footer.html";i:1566381559;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<div class="page-container">
    <section id="formAjax">
        <div class="text-c">
            ...
            <input type="text" name="search" value="<?php echo htmlentities(app('request')->get('search')); ?>" id="search" placeholder=" 创意" style="width:250px" class="input-text">
            ...
            <span class="select-box inline">
				<select class="select" name="sort" id="sort" style="width: 150px;">
					...
					<option value="3" <?php if($param['sort']==3): ?>selected<?php endif; ?>>作品数从高到低</option>
					<option value="4" <?php if($param['sort']==4): ?>selected<?php endif; ?>>作品数从低到高</option>
				</select>
            </span>
        </div>
    </section>
    ...
    <table class="table table-border table-bordered table-bg">
        ...
        <form id="multi-check">
            ...
            <tr class="text-c userinfo">
                ...
                <td><?php echo htmlentities($li['works_num']); ?></td>
                ...
                <td>
                    <?php if($li['status'] == 0): ?>
                    <a class="btn btn-link radius" style="text-decoration:none;" onClick="idea_shenhe(this,<?php echo htmlentities($li['id']); ?>)" href="javascript:;" title="审核">审核</a>
                    <?php else: ?>
                ...
                <td class="td-manage">
                    <span>
                        <a style="text-decoration:none" onclick="pagefull('创意详情','<?php echo url("Req/ideaDetail",array("id"=>$li["id"])); ?>')" href="javascript:;" title="创意详情">
                            <i class="Hui-iconfont">&#xe6df;</i>
                        </a>
                    </span>
                    <span>
                        <a style="text-decoration:none" onClick="idea_del(this,<?php echo htmlentities($li['id']); ?>)" href="javascript:;" title="删除">
                        <i class="Hui-iconfont">&#xe6e2;</i>
                        </a>
                    </span>
                </td>
...
<script type="text/javascript">
    ...
    var url = '<?php echo url("Req/ideaList"); ?>' + '?<?php echo $page["query"];?>';
    ...
    $("#search-btn").click(function () {
        ...
        if(sort.length != '') {
            ...
            window.location.href = '<?php echo url("Req/ideaList"); ?>' + '?' + str;
    });
        ...
        layer.confirm('审核创意？', {
            ...
            function(){
                layer.prompt({
                    ...
                    layer.close(index);
                    $.ajax({
                        url:"<?php echo url('Req/ideaReject'); ?>",
                        type:'post',
                        dataType:'json',
